...
urlpatterns = [
    ...
    path("cliente/<int:id_cliente>/detalhe", views.cliente_detalhe_json, name="cliente_detalhe_json"),
    ...
    path("excluir-vendedor/", views.excluir_vendedor, name="excluir_vendedor"),
    ...
    path("excluir-fornecedor/", views.excluir_fornecedor, name="excluir_fornecedor"),
    ...
    path("excluir-categoria/", views.excluir_categoria, name="excluir_categoria"),
]