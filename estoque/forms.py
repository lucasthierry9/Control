...
class MovimentacaoForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column('tipo', css_class='col-12 col-md-6 mb-1'),
                Column('produto', css_class='col-12 col-md-6 mb-1'),
            ),
            Row(
                Column('quantidade', css_class='col-12 col-md-6 mb-3'),
                Column('deposito', css_class='col-12 col-md-6 mb-3'),
            ),
            Row(
                Column('preco_compra', css_class='col-12 col-md-6 mb-3'),
                Column('preco_custo', css_class='col-12 col-md-6 mb-3'),
            ),
            Row(
                Column('dataehora', css_class='col-12 col-md-6 mb-3'),
            ),
